...
# Metrics
SNAPSHOT_TIME = Histogram("Qonduit_snapshot_duration", "Snapshot creation time", ["type"])
SNAPSHOT_SIZE = Counter("Qonduit_snapshot_bytes", "Snapshot size in bytes")
VERSION_GAUGE = Gauge("Qonduit_state_versions", "Current snapshot version")
