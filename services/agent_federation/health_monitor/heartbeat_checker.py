...
# Metrics Setup
HEARTBEAT_COUNTER = Counter("Qonduit_heartbeat_total", "Total heartbeats", ["protocol"])
FAILURE_COUNTER = Counter("Qonduit_heartbeat_failures", "Failure count", ["node_type"])
LATENCY_SUMMARY = Gauge("Qonduit_heartbeat_latency", "Heartbeat latency in ms")
